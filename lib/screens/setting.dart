    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Container(
          ...
          child: Text(
            'Profile',
            style: TextStyle(color: Colors.black, fontSize: 28, fontFamily: 'poppins',fontWeight: FontWeight.bold),
          ),
        ),
        actions: [],
        centerTitle: true,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  'widigda@gmail.com',
                                  style: TextStyle(fontFamily: 'poppins', color: Colors.lightBlueAccent),
                                ),
                              ),
                            ],
                          ),
